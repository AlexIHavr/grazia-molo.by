...
class PostController {
  ...
  async deletePostPhoto(
    req: Request<{}, {}, deletePostRequestType>,
    res: Response,
    next: NextFunction
  ) {
    try {
  ...
  async createPostComment(
    req: Request<{}, {}, postCommentRequestType>,
    res: Response,
    next: NextFunction
  ) {
    try {
  ...
  async getUnvalidatedComments(req: Request, res: Response, next: NextFunction) {
    try {
      const comments = await postService.getUnvalidatedComments();
      res.json(comments);
    } catch (e) {
      next(e);
    }
  ...
  async changeIsValidateComments(
    req: Request<{}, {}, isValidatedCommentsRequest>,
    res: Response,
    next: NextFunction
  ) {
    try {
